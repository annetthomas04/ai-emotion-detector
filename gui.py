...
def show_subject():      
    ...
    bounding_box = cv2.CascadeClassifier('C:/Users/Annet Thomas/anaconda3/Lib/site-packages/cv2/data/haarcascade_frontalface_default.xml')
...
if __name__ == '__main__':
    ...
    lmain.place(x=50,y=140)
    lmain3.pack()
    lmain3.place(x=800,y=35)
    lmain2.pack(side=RIGHT)
    lmain2.place(x=700,y=140)
